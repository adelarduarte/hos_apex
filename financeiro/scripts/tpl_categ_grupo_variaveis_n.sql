create or replace procedure "TPL_CATEG_GRUPO_VARIAVEIS" (
...
is
    -->> Categorias do grupo variáveis - Competência <<--
    ----*********************************************----
...
Begin
    dbms_output.put_line('-->> Categorias Grupo variáveis - Competência');
